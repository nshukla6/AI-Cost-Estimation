  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">Vendors &amp; Uploads</h1>
          <p className="text-sm text-muted-foreground">Manage AI vendors and monthly cost sheets</p>
        </div>
      ...
      >
        ...
        <FormField label="CSV File" required>
          ...
          <p className="text-xs text-muted-foreground">Expected columns: email,amount_usd — see docs/MOCK_BACKEND.md</p>
        </FormField>
      </SideSheet>
    </div>
  )
